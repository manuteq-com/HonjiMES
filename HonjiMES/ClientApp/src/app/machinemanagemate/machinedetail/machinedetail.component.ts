...
@Component({
    selector: 'app-machinedetail',
    templateUrl: './machinedetail.component.html',
    styleUrls: ['./machinedetail.component.css']
})
export class MachinedetailComponent implements OnInit, OnChanges {
    ...
    ngOnChanges() {
        ...
        } else if (this.modval === 'edit' && this.itemkeyval != null && this.itemkeyval !== 0) {
        ...
        } else if (this.modval === 'view') {
            this.disabled = false;
            this.WorkOrderNovisible = true;
            this.processVisible = true;
            this.runVisible = true;
        }
