...
export class WorkorderListComponent implements OnInit {
    ...
    tdclick(e, colData) {
        //console.log("tdclick-e",e);
        //console.log("tdclick-coldata",colData);
