...
@Component({
    selector: 'app-ordertowork',
    templateUrl: './ordertowork.component.html',
    styleUrls: ['./ordertowork.component.css']
})
export class OrdertoworkComponent implements OnInit, OnChanges {
